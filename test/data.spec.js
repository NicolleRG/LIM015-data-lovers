import { sortData, rankingOnlyMedals, rankingOnlyMedalsTwo, rankingTotalMedals, rankingTotalAthletes, searchTable, filterOnlyOneName, filterByValue, filterByValueTwo, sortDataTwo, sortByMedal, sortDataTwoByNumber, average, athletesByGender, percentage, arrRankingCardAthlete, arrayDataCountry} from '../src/data.js';
...
describe('rankingOnlyMedalsTwo', () => {
  it('is a function', () => {
    expect(typeof rankingOnlyMedalsTwo).toBe('function');
  });
  it('returns array ranking ordenado por medallas `Gold`', () => {
    expect(rankingOnlyMedalsTwo(data3,'Gold','desc')).toEqual([
      ['USA',[
      {
        "name": "Rachael Alexis Adams",
        "gender": "F",
  ...
  it('returns array ranking ordenado por medallas `Silver`', () => {
    expect(rankingOnlyMedalsTwo(data3,'Silver','desc')).toEqual([
      ['USA',[
      {
        "name": "Rachael Alexis Adams",
        "gender": "F",
  ...
  it('returns array ranking ordenado por medallas `Gold`', () => {
    expect(rankingOnlyMedalsTwo(data3,'Bronze','desc')).toEqual([
      ['USA',[
        {
          "name": "Rachael Alexis Adams",
          "gender": "F",
...
describe('filterByValue', () => {
  ...
  it('returns array de objetos que contengan por valor `ALG`', () => {
    expect(filterByValue(data, 'noc', 'ALG')).toEqual([["ALG", 
    [{
        "name": "Giovanni Abagnale",
        "gender": "M",
        "height": "198",
  ...
  it('returns array de objetos que contengan por valor `PER`', () => {
      expect(filterByValue(data, 'noc', 'PER')).toEqual([['PER',[
        {
          "name": "Luc Abalo",
          "gender": "M",
          "height": "182",
...
describe('filterByValueTwo', () => {
  it('is a function', () => {
    expect(typeof filterByValueTwo).toBe('function');
  });
  it('returns array de objetos que contengan por valor `F`', () => {
    expect(filterByValueTwo(data2, 'gender','F')).toEqual([{
      "name": "Patimat Abakarova",
      "gender": "F",
      "height": "165",
      "weight": "49",
...
describe('athletesByGender', () => {
  ...
  it('returns array filtrado por género `F`', () => {
    expect(athletesByGender(data2, 'F')).toEqual([{
      "name": "Patimat Abakarova",
      "gender": "F",
      "height": "165",
      "weight": "49",
...
describe('percentage', () => {
  ...
  it('returns `50` para 40 de un total de 80', () => {
    expect(percentage(40,80)).toBe(50);
  });
  it('returns `35,71` para 25 de un total de 70', () => {
    expect(percentage(25,70)).toBe(35.71);
  });
});